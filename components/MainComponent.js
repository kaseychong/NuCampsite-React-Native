...
import { fetchCampsites, fetchComments, fetchPromotions,
    fetchPartners } from '../redux/ActionCreators'; //import action creators here so Main Component updates state from redux
...
export default connect(null, mapDispatchToProps)(Main); //null first since mapstatetoprops is not being used